"""
Django settings for share_or_announce project.
...
SECRET_KEY = 'django-insecure-rd8ssvtri2=qb%y5w#*v@3bro(0n-!0_@!n$=jxk0-3r%2^1^s'
...
ROOT_URLCONF = 'share_or_announce.urls'
...
WSGI_APPLICATION = 'share_or_announce.wsgi.application'
...
CRONJOBS = [
    ('*/1 * * * *', 'profiles.cron.modify_names'),  # Run every minute
]
